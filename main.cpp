...
void display(void)
{
    ...
    glColor3f(red);
    glTranslatef(30, 55, 420);
    glutSolidSphere(16.0, 10, 10);//哑铃球
    glTranslatef(-30, -55, -420);

    glColor3f(red);
    glTranslatef(30, 55, 380);
    glutSolidSphere(16.0, 10, 10);//哑铃球
    glTranslatef(-30, -55, -380);



    constract(30, 55, 380, 5, 5, 40);//哑铃棍
    glColor3f(0.0, 1.0, 1.0);
    build();
    ...
    glColor3f(red);
    glTranslatef(30, 85, 420);
    glutSolidSphere(16.0, 10, 10);//哑铃球
    glTranslatef(-30, -85, -420);

    glColor3f(red);
    glTranslatef(30, 85, 380);
    glutSolidSphere(16.0, 10, 10);//哑铃球
    glTranslatef(-30, -85, -380);



    constract(30, 85, 380, 5, 5, 40);//哑铃棍
    glColor3f(0.0, 1.0, 1.0);
    build();
    ...
    glColor3f(red);
    glTranslatef(30, 115, 420);
    glutSolidSphere(16.0, 10, 10);//哑铃球
    glTranslatef(-30, -115, -420);

    glColor3f(red);
    glTranslatef(30, 115, 380);
    glutSolidSphere(16.0, 10, 10);//哑铃球
    glTranslatef(-30, -115, -380);



    constract(30, 115, 380, 5, 5, 40);//哑铃棍
    glColor3f(0.0, 1.0, 1.0);
    build();
...
void init(void)
{
    ...
    glLineWidth(5);
    glColor3f(1.0, 1.0, 1.0);       //定义背景颜色为黑色
